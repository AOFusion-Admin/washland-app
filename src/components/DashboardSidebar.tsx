  ...
  return (
    <div className="sidebar" style={{
      ...
      <div style={{
        ...
        <Link href="/washland/dashboard" style={{ textDecoration: 'none', color: 'inherit' }}>
          <div style={{ 
            display: 'flex', 
            alignItems: 'center', 
              ...
              >
                <div
                  ...
                  onMouseEnter={(e) => {
                    ...
                    // Show tooltip/submenu for collapsed mode
                    if (isCollapsed) {
                      // First, hide all other tooltips
                      const allTooltips = document.querySelectorAll('.tooltip-text') as NodeListOf<HTMLElement>
                      allTooltips.forEach(tooltip => {
                        if (tooltip !== e.currentTarget.querySelector('.tooltip-text')) {
                          tooltip.style.opacity = '0'
                          tooltip.style.pointerEvents = 'none'
                        }
                      })
                      
                      // Then show current tooltip
                  ...
                  onMouseLeave={(e) => {
                    ...
                    if (isCollapsed) {
                      // Use setTimeout to allow moving to submenu before hiding
                      setTimeout(() => {
                        const tooltip = e.currentTarget.querySelector('.tooltip-text') as HTMLElement
                        if (tooltip && !tooltip.matches(':hover') && !e.currentTarget.matches(':hover')) {
                          tooltip.style.opacity = '0'
                          tooltip.style.pointerEvents = 'none'
                        }
                      }, 100)
